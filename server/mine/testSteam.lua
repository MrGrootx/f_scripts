...
local img =
'https://media.discordapp.net/attachments/1163004945088397383/1218068083743133778/SPOILER_saree_dress.png?ex=6687844d&is=668632cd&hm=c96889a02deb5362c1464c9219e33ccc34ff9b9ba0078bca157b378e60c99c3e&=&format=webp&quality=lossless&width=350&height=350'
local steamKey = '9F17E28D6A7ADAF6269E6EA248EB41B5'
function GetSteamID(id)
   local steamid = tostring(id):match("steam:") and id or nil
   if not steamid then
   ...
   PerformHttpRequest(url, function(err, text, headers)
      if err == 200 then
         ...
         if data.response.players[1] ~= nil then
            ...
            print(data.response.players[1].avatarfull)
         else
            p:resolve(img)
         end
      else
